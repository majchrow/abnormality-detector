...
def setup_routes(app: web.Application):
    ...
    cors.add(app.router.add_get('/anomaly-detection/{conf_name}', is_anomaly_monitored))
    ...
    cors.add(app.router.add_put('/anomaly-detection/once/{conf_name}', run_inference))
    ...
    cors.add(app.router.add_put('/monitoring/once/{conf_name}', run_monitoring))
